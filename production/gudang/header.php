<?php 
session_start();
if (!isset($_SESSION['username']) and ($_SESSION['nama_pengguna']) and ($_SESSION['level'])){
...
<html lang="en">
  <head>
    ...
    <link href="../../build/js/bootbox.min.js" rel="stylesheet">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-th-list"></i>Master <span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a a href="barang_pembelian.php"><i class="fa fa-th-large"></i>Barang Pembelian </a>
                  </li>
