...
.style10b {
  ...
  <h2><div class="style19b" style="text-align: center; font-size: 18pt;"><u>Laporan Data Supplier</u></div></h2>
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="8">
      <hr />      
    ...
    <tr>
      ...
      <td width="100" class="style6"><div align="left">Kode Pelanggan</div></td>
      <td width="90" class="style6"><div align="left">Nama Pelanggan</div></td>
      <td width="60" class="style6"><div align="center">Alamat</div></td>
      <td width="80" class="style6"><div align="center">Telepon</div></td>
    </tr>
      <tr>
      <td colspan="8">
      <hr />      </td>
      ...
      <?php
      	$no = 1;
      	$tampil = mysqli_query($konek, "SELECT * FROM pelanggan ");
		while ($data1 = mysqli_fetch_assoc($tampil)){	
	  ?>
      <tr>
        <td class="style9" align="left"><?php echo $no++;?>.</td>
        <td class="style9"><?php echo $data1['kode_pelanggan'];?></td>
        <td class="style9"><?php echo $data1['nama_pelanggan'];?></td>
        <td class="style9" align="center"><?php echo $data1['alamat'];?></td>
        <td class="style9" align="center"><?php echo $data1['telepon'];?></td>
      </tr>
      <?php }?>
      <tr>
      <td colspan="8">
