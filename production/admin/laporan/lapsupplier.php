...
.style10b {
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="100" class="style6"><div align="left">Kode Supplier</div></td>
      <td width="90" class="style6"><div align="left">Nama Supplier</div></td>
      <td width="100" class="style6"><div align="center">Alamat</div></td>
      <td width="100" class="style6"><div align="center">Telepon</div></td>
    </tr>
      <tr>
      <td colspan="8">
      <hr />      </td>
      ...
      <?php
      	$no = 1;
      	$tampil = mysqli_query($konek, "SELECT * FROM supplier ");
		while ($data1 = mysqli_fetch_assoc($tampil)){	
	  ?>
      <tr>
        <td class="style9" align="left"><?php echo $no++;?>.</td>
        <td class="style9"><?php echo $data1['kode_supplier'];?></td>
        <td class="style9"><?php echo $data1['nama_supplier'];?></td>
