...
<h2>
	<div class="style19b" style="text-align: center; font-size: 18pt;"><u>Laporan Data Barang Masuk</u></div>
</h2>
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="12">
	...
	<tr>
	  ...
	  <td width="100" class="style6"><div align="left">Nota Order</div></td>
      <td width="80" class="style6"><div align="left">Kode Barang</div></td>
      <td width="100" class="style6"><div align="center">Nama Barang</div></td>
      <td width="100" class="style6"><div align="center">Keterangan</div></td>
      <td width="80" class="style6"><div align="right">Harga Beli</div></td>
      <td width="80" class="style6"><div align="right">Jumlah</div></td>
		</td>
	</tr>
	<tr>
		<td colspan="12">
	...
	<?php
      	$no = 1;
      	$tampil = mysqli_query($konek, "SELECT * FROM d_pembelian dpem JOIN barang brg ON dpem.kode_barang = brg.kode_barang JOIN pembelian pem ON pem.faktur_pembelian = dpem.faktur_pembelian");
		while ($data1 = mysqli_fetch_assoc($tampil)){
			$jumlah = $data1['jumlah'];
			$total_jumlah = $total_jumlah + $jumlah;
	  ?>
	<tr>
		<td class="style9" align="left"><?php echo $data1['faktur_pembelian'];?></td>
		<td class="style9" align="left"><?php echo $data1['nota_order'];?></td>
		...
		<td class="style9" align="right"><?php echo $data1['jumlah'];?></td>
	</tr>
	<?php }?>
	<tr>
		<td colspan="12">
...
<table width="98%" align="center">
    ...
    <tr>
      <td colspan="6" align="right" class="st_total">TOTAL BARANG MASUK :</td>
      <td width="150" align="right"><div id="total" class="st_total" align="right"> 
      <?php echo number_format($total_jumlah); ?>
      </div></td>
    </tr>
  </table>
