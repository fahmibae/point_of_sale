<?php
session_start();
if (!isset($_SESSION['username']) and ($_SESSION['level']) and ($_SESSION['nama_pengguna']) and ($_SESSION['id_user'])){
...
<script type="text/javascript">
  function showTime(){
    ...
    document.getElementById('waktu').innerHTML = jam + ":" + menit + ":" + detik + " " + am_pm;
  }
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-th-list"></i>Master <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                 ...
                 <li><a a href="pemesanan.php"><i class="fa fa-shopping-cart"></i>Pemesanan </a>
                  </li>

                  <li><a><i class="fa fa-money"></i>Transaksi <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="transaksi_pembelian.php">Pembelian</a></li>
                      <li><a href="transaksi_penjualan.php">Penjualan</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-credit-card"></i>Cicilan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="hutang.php">Hutang</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-file-text"></i>Laporan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="laporan/proses_barang.php">Laporan Barang</a></li>
                      <li><a href="laporan/proses_supplier.php">Laporan Supplier</a></li>
                      <li><a href="laporan_pembelian_periode.php">Laporan Pembelian</a></li>
                      <li><a href="laporan_penjualan_periode.php">Laporan Penjualan</a></li>
                      <li><a href="laporan_hutang_periode.php">Laporan Hutang</a></li>
                      <li><a href="laporan/proses_barang_masuk.php">Laporan Barang Masuk</a></li>
                      <li><a href="laporan/proses_penjualan_terlaris.php">Laporan Barang Keluar</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
            ...
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                  ...
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="../images/user.png" alt=""><?=$_SESSION['nama_pengguna']?>
                ...
                <li style="text-align: left;">
                  <a id="waktu" style="font-size: 17px; color: #26B99A;"></a></li>
              </ul>
            </nav>
          </div>
        </div>
